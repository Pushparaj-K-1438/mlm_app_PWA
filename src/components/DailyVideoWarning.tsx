...
import { AlertTriangle, Play, Clock, Video, ArrowRight } from "lucide-react";
      ...
      <div className="w-full max-w-md">
        ...
        <div className="bg-white rounded-3xl shadow-xl overflow-hidden">
          ...
          <div className="bg-gradient-to-r from-blue-500 to-indigo-600 p-6 text-white">
            ...
            <h3 className="text-xl font-bold text-center">Daily Video Required</h3>
            <p className="text-center text-blue-100 mt-2">
              Complete today's video to unlock all features
            </p>
          </div>
          ...
          <div className="p-6">
            <div className="space-y-4 mb-6">
              <div className="flex items-start">
                ...
                <div>
                  <h4 className="font-medium text-gray-900">Watch Daily Video</h4>
        ...
        <div className="mt-6 text-center">
          <p className="text-sm text-gray-600">
            This is a required daily activity to maintain your account status
          </p>
        </div>
      </div>
    </div>
